...
<div style="text-align:left;font-family: Helvetica Neue,sans-serif; background-color:#f7f7f7; color:#636363;">
  ...
  <table>
  <tr>
  <td>Time 1: <input type="time" name="Time1" value="Enter time 1"></td>
  </tr>
  <tr>
  <td>Time 2: <input type="time" name="Time2" value="Enter time 2"></td>
  </tr>
  <tr>
  <td>Date 1: <input type="date" name="date1" value=""></td>
  </tr
  <tr>
  <td>Date 2: <input type="date" name="date2" value=""></td>
  </tr>
  <tr>
  <td><input type="submit" value="Submit" style="background-color: black;
  border: none;
  color: white;
  padding: 16px 32px;
  text-align: center;
...
<h2> <?php if(isset($_POST['Time1']) && isset($_POST['Time2']) && isset($_POST['date1']) && isset($_POST['date2'])) echo "Results"; ?></h2>
<?php
 if(isset($_POST['Time1']) && isset($_POST['Time2']) && isset($_POST['date1']) && isset($_POST['date2'])){
  //   $_t1 = $_GET['Time1'];
  //   $_t2 = $_GET['Time2'];
  //   $_date = $GET['date1'];
  //   $_date2 = $GET['date2'];
  //   $val1 = $GET['date1']." ".$_GET['Time1'];
  //   $val2 = $_GET['date2']." ".$_GET['Time2'];
     //echo $val1." ".$val2;
    // echo $_GET['Time2'];
$sql = "SELECT * FROM notices where Disaster_Time BETWEEN '".$_POST["date1"]." ".$_POST["Time1"]."' AND '".$_POST["date2"]." ".$_POST["Time2"]."' ;";
